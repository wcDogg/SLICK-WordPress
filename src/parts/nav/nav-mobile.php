		...
		<div data-modal>
			<div data-modal-content>
				...
				<div data-modal-grid>
					...
					<?php 
						if ( $location_01 ) : 
							echo '<nav id="nav-header-01" class="nav--vertical nav--text" role="navigation" aria-label="'.esc_attr($location_01).'">';
						...
						if ( $location_02 ) : 
							echo '<nav id="nav-header-02" class="nav--vertical nav--text" role="navigation" aria-label="'.esc_attr($location_02).'">';
						...
						if ( $location_03 ) :
							echo '<nav id="nav-header-03" class="nav--vertical nav--text" role="navigation" aria-label="'.esc_attr($location_03).'">';
						...
						if ( $location_04 ) : 
							echo '<nav id="nav-header-04" class="nav--vertical nav--text" role="navigation" aria-label="'.esc_attr($location_04).'">';
						...
						if ( $location_05 ) : 
							echo '<nav id="nav-header-05" class="nav--vertical nav--text" role="navigation" aria-label="'.esc_attr($location_05).'">';
						...
						if ( $location_06 ) : 
							echo '<nav id="nav-header-06" class="nav--vertical nav--text" role="navigation" aria-label="'.esc_attr($location_06).'">';
