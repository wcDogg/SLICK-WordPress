...
foreach ($brands as $term) :
    ...
    ?>
        ...
        <div class="card card--brand">
            <?php echo '<a class="overlay__link" rel="bookmark" href=" '.esc_url($term_url).' " title=" '. esc_attr($term_name).' ">' ;?>

            
                <div class="overlay__wrap">
                    <div class="overlay"></div>
                    
                    <?php echo '<img class="overlay__img" src="'.esc_url($image_url).'" alt="'.esc_attr($term_name).'" />'; ?>
